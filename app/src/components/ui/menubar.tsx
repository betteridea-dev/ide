...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground cursor-pointer data-[state=open]:bg-accent data-[state=open]:text-accent-foreground flex items-center px-2 py-1 text-sm font-medium outline-hidden select-none",
        className
      )}
      {...props}
    />
  ...
  return (
    <MenubarPortal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground rounded-b data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[12rem] origin-(--radix-menubar-content-transform-origin) overflow-hidden border shadow-md",
          className
        )}
        {...props}
      />
