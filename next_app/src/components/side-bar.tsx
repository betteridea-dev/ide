...
export default function SideBar({
  ...
  const handleRenameFile = (pname: string, fname: string) => {
    if (!isValidExtension(newFileName)) {
      toast.error(
        "Invalid file extension. Only .lua, .luanb, and .md are supported."
      );
      return;
    }
  ...
  return (
    <div
      ...
      className="absolute flex flex-col truncate justify-center left-0 z-50 transition-all duration-200 bg-background w-[50px] data-[collapsed=false]:w-[250px] border-r h-[calc(100vh-89px)]"
        ...
        {mounted &&
          projects.map((pname, _) => {
            ...
            const ownedByActiveWallet =
              manager.projects[pname].ownerWallet == activeAddress;
            ...
            return (
              <div key={_}>
                <div
                  data-active={active}
                  data-collapsed={collapsed}
                  className=" cursor-default h-fit rounded-none flex relative gap-2 px-3 mb-2 data-[active=true]:mb-0 items-start data-[collapsed=false]:justify-start data-[collapsed=true]:justify-center"
                  key={_}
                >
                  <Icons.folder
                    data-collapsed={collapsed}
                    ...
                    onClick={() => {
                      ...
                      if (typeof ownerAddress == "string")
                        shortAddress =
                          ownerAddress.slice(0, 5) +
                          "..." +
                          ownerAddress.slice(-5);
                      ...
                      if (!ownedByActiveWallet)
                        toast.error(
                          "The owner wallet for this project cant be verified",
                          {
                            description: `It was created with ${shortAddress}.\nSome things might be broken`,
                            id: "error",
                          }
                        );
                  ...
                  {!collapsed && (
                    <div className="flex flex-col w-full">
                      ...
                      >
                        <Icons.play
                          data-active={active}
                          className="fill-foreground data-[active=true]:fill-primary stroke-none mr-1 data-[active=true]:rotate-90"
                          height={12}
                          width={12}
                        />
                  ...
                  <div className="flex flex-col items-center justify-center px-3 mb-3 w-full">
                    <div className="flex justify-between items-center w-full">
                      ...
                      <Dialog onOpenChange={(open) => setCollapsed(!open)}>
                        <DialogTrigger className="hover:bg-accent/70 px-2">
                          :
                        </DialogTrigger>
                        <DialogContent>
                            ...
                            <div className="w-full flex">
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  >
                                    <DialogTrigger className="px-2 hover:bg-accent/70">
                                      :
                                    </DialogTrigger>
                                    <DialogContent>
                                      <div className="flex flex-col gap-2">
