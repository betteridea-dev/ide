...
import TopBar from "@/components/archive/top-bar";
import FileBar from "@/components/archive/file-bar";
import SideBar from "@/components/archive/side-bar";
import { useProjectManager } from "@/hooks";
import BottomTabBar from "@/components/archive/bottom-tab-bar";
...
import BottomStatusbar from "@/components/archive/bottom-statusbar";
import Ansi from "ansi-to-react";
import SettingsTab from "@/components/archive/settings-tab";
