...
export default function Packages() {
    ...
    return <div className="flex gap-2 h-full max-h-[80vh] w-full p-2">
        <div className="flex flex-col gap-1 w-[269px]">
            ...
            <div className=" overflow-scroll p-0.5 flex flex-col gap-0.5">
                {
        ...
        <div className="border w-full border-foreground/10 rounded-lg grow overflow-scroll whitespace-normal">
